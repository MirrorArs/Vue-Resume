...
export default {
    components:{ProfileEditor,StudyHistory,WorkHistory,ProjectsHistory,HonorsHistory,ContactInformation},
    props:['resume'],
    data() {
        return {
            currentTab: 0,
            icons: ['shenfenzheng', 'book', 'work', 'project', 'jiangbeishengli', 'phone'],
            methods: {
            },
            created() {
    }
